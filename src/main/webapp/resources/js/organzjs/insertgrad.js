			...
			.extend(
					$.ui.autocomplete.prototype,
					{
						_renderMenu : function(ul, items) {
							// remove scroll event to prevent attaching multiple
							// scroll events to one container element
							$(ul).unbind("scroll");
							var self = this;
			...
			.autocomplete(
					{
						source : function(request, response) {
							...
							results = $.ui.autocomplete.filter(availableTags,
									request.term);
							if (!results.length) {
